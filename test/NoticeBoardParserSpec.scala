...
class NoticeBoardParserSpec
  ...
  "A NoticeBoard Parser" should {
    "parse the notice board for 'Informatik'" in {
    ...
    "parse the notice board for 'Grundstudium Ingenieurwissenschaften'" in {
      val board = NoticeBoard(
    ...
    "parse the notice board for 'Maschinenbau, Wirtschaftsingenieurwesen, Produktdesign und Prozessentwicklung'" in {
      val board = NoticeBoard(
    ...
    "parse the notice board for 'Elektrotechnik und Automation and IT'" in {
      val board = NoticeBoard(
