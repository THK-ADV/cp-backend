  ...
  "A Noticeboard Parser" should {
    "parse the noticeboard for 'Informatik'" in {
      val board = Noticeboard(
        ...
        List(
          NoticeboardEntry(
            ...
            DateTime.parse("2021-07-23T10:03:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2021-07-06T13:25:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2021-06-30T09:20:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2021-06-29T09:08:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2021-04-14T11:18:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2021-03-24T10:51:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2019-12-19T13:47:00+00:00")
          )
        )
      )
      ...
      res.entries.zip(board.entries).foreach { case (lhs, rhs) =>
        ...
        DateTimeFormatOps.isoDate.print(lhs.published) shouldBe DateTimeFormatOps.isoDate.print(rhs.published)
      }
    }
      ...
      val board = Noticeboard(
        ...
        List(
          NoticeboardEntry(
            ...
            DateTime.parse("2021-08-06T09:13:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2021-07-30T11:22:00+00:00")
          ),
          NoticeboardEntry(
            "Kaffeebar wieder geöffnet",
            "und BAföG-Beratung vor Ort ab 15.07.21",
          ...
          NoticeboardEntry(
            ...
            DateTime.parse("2021-03-29T08:58:00+00:00")
          ),
          NoticeboardEntry(
            "(WPF) Steuern und Regeln in der Umwelttechnik",
            "WPF im SoSe 2021",
          ...
          NoticeboardEntry(
            ...
            DateTime.parse("2020-09-17T13:45:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2020-09-10T12:20:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2020-07-16T12:22:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2020-07-06T21:15:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2020-06-18T09:10:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2020-03-27T10:59:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2020-03-21T16:36:00+00:00")
          ),
          NoticeboardEntry(
            "Änderungen in der Modulprüfung Qualitätsmanagement",
            "ab dem Sommersemester 2020",
      ...
      val board = Noticeboard(
        ...
        List(
          ...
          NoticeboardEntry(
            ...
            DateTime.parse("2021-07-21T12:30:00+00:00")
          ),
          NoticeboardEntry(
            "Kaffeebar wieder geöffnet",
            "und BAföG-Beratung vor Ort ab 15.07.21",
          ...
          NoticeboardEntry(
            ...
            DateTime.parse("2021-06-13T07:36:00+00:00")
          ),
          NoticeboardEntry(
            "(WPF) Steuern und Regeln in der Umwelttechnik",
            "WPF im SoSe 2021",
          ...
          NoticeboardEntry(
            ...
            DateTime.parse("2021-01-25T12:36:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2020-11-04T14:30:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2020-11-04T13:52:00+00:00")
          ),
          NoticeboardEntry(
            ...
            DateTime.parse("2020-11-02T14:33:00+00:00")
          ),
          NoticeboardEntry(
            "Fächerangebote Studiengang Elektronik",
            "Wintersemester 2020 / 2021",
